<div class="flex flex-col items-center justify-center px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:pt-32 md:px-0 bg-blue-100 bg-right-bottom bg-no-repeat bg-cover bg-cloudy">
