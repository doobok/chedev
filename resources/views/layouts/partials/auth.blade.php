...
@guest
    <div class="flex space-x-1 items-center">
        <span>логин:</span>
        <a href="{{ route('login', 'google') }}" target="_blank" title="Google" class="border border-dashed border-gray-300 p-0.5 transition-colors duration-300 hover:text-secondary">
        ...
        <a href="{{ route('login', 'facebook') }}" target="_blank" title="Facebook" class="border border-dashed border-gray-300 p-0.5 transition-colors duration-300 hover:text-secondary">
            <svg viewBox="0 0 24 24" fill="currentColor" class="h-4">
                <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
            </svg>
        </a>
        <a href="{{ route('login', 'github') }}" target="_blank" title="Github" class="border border-dashed border-gray-300 p-0.5 transition-colors duration-300 hover:text-secondary">
            <svg viewBox="0 0 24 24" fill="currentColor" class="h-4">
