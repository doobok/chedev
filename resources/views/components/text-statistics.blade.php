<div class="flex flex-row text-sm space-x-3">
    ...
    @isset($views_count)
            <span>|</span>
            <span title="{{ __('site.views-count') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
    ...
    @isset($comments_count)
            <span>|</span>
            <span v-scroll-to="'#comments'" title="{{ __('site.comments-count') }}" class="cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
        ...
        <span title="{{ __('site.comments-count') }}">
            {{ $comments_count }}
        </span>
    @endisset
</div>
