        ...
        <div class="px-4 py-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-12">
            <div class="grid gap-5 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
                @foreach($data as $item)
                    <div class="overflow-hidden transition-shadow duration-300 bg-white rounded bg-gray-50 hover:bg-gray-100 shadow-md p-1">
                        ...
                        <div class="py-5 px-2">
                            ...
                            <a href="{{ route('page', $item->slug) }}"
                               class="inline-flex items-center justify-center h-10 px-6 mr-6 tracking-wide text-white transition duration-200 rounded shadow-md bg-blue-500 hover:bg-blue-700 focus:shadow-outline focus:outline-none"
                            >
                                {{ __('site.read-more') }}
                            </a>
                        </div>
