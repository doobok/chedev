        ...
        <div class="grid gap-4 mx-auto grid-cols-1 lg:max-w-screen-lg">
            ...
            >
                <div class="flex flex-row items-center space-x-3">
                    <img :src="'/storage/' + comment.user.avatar" :alt="comment.user.name" class="h-14 mr-1 text-gray-600 rounded-full border-2 border-gray-300 ">
...
<!--                    </svg>-->
        ...
        <div id="comment-form" v-if="!sent" class="mt-3">
            ...
            <div class="flex flex-wrap justify-between items-center">
                <span class="text-sm text-gray-400">Ви коментуєте від імені <b class="mx-4">Incognito</b> {{comment.length}}/200</span>
                <button
